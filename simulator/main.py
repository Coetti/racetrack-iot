...
BROKER_HOST = "localhost"        # Docker local
BROKER_PORT = 1883

# Para utilizar o broker público do HiveMQ:
...
class CarPhysics:
    ...
    _RAW_TRACK = [
        (0.12, "straight",   1.00),   
        (0.04, "brake_zone", 0.30),   
        (0.06, "corner",     0.30),   
        (0.04, "accel",      0.65),   
        (0.10, "straight",   0.85),   
        (0.03, "brake_zone", 0.42),   
        (0.07, "corner",     0.42),   
        (0.04, "accel",      0.72),
        (0.15, "straight",   1.00),  
        (0.05, "brake_zone", 0.25),   
        (0.08, "corner",     0.25),   
        (0.05, "accel",      0.58),
        (0.08, "straight",   0.80),
    ...
    def _compute_rpm(self, speed: float, gear: int) -> int:
        ...
        noise = random.uniform(-0.01, 0.01) * rpm_range  
